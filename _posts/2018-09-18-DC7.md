...
It's now time to deal with the missing data. There are several strategies for this: We can drop them, fill them in using the mean of the column or row that the missing value is in (also known as [imputation](https://en.wikipedia.org/wiki/Imputation_(statistics))), or, if we are dealing with time series data, use a forward fill or backward fill, in which you replace missing values in a column with the most recent known value in the column. See [pandas Foundations](https://www.datacamp.com/courses/pandas-foundations) for more on forward fill and backward fill.
...
## Datasets
* [Air Quality](https://assets.datacamp.com/production/course_2023/datasets/airquality.csv)
* [DOB job application filings](https://assets.datacamp.com/production/course_2023/datasets/dob_job_application_filings_subset.csv)
* [Ebola](https://assets.datacamp.com/production/course_2023/datasets/ebola.csv)
* [Gapminder](https://assets.datacamp.com/production/course_2023/datasets/gapminder.csv)
* [Tuberculosis](DOB job application filings)
* [Tips](DOB job application filings)
* [NYC Uber Data](https://assets.datacamp.com/production/course_2023/datasets/nyc_uber_2014.csv)
